...
for i in range(1, 10):
	...
	quote_page = 'https://www.seek.com.au/jobs-in-information-communication-technology/in-All-Australia?keywords=%22Security%22%20or%20%22Forensic%22%20or%20%22cyber%22&savedsearchid=13809772%27&page={}'.format(i)
	...
	for article in soup.find_all('article'):
		...
		#Get the job title
		template_title = new_soup.find('h1')
		if template_title:
