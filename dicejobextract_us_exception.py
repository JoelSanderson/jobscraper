...
python dicejobextract_us_exception.py
...
for i in range(1, 20):	
	if exception_counter >= 3:
		print()
		print('Encountered multiple exceptions in a row, ending script')
		print('Page: {}'.format(i))
		break
	...
	for article in soup.find_all('div', class_='serp-result-content'):
		...
		if exception_counter > 0:		
			exception_counter -= 1
		debug_print('Exception Counter: {}'.format(exception_counter))
